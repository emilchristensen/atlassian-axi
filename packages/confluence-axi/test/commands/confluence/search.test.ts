...
describe("confluence search", () => {
  ...
  it("renders space-entity hits with the space key as id and entityType as type", async () => {
    ...
    const spaceHit = {
      results: [
        {
          space: { key: "INTD", name: "Internal Space D", type: "global" },
          title: "Internal Space D",
          excerpt: "",
          entityType: "space",
          resultGlobalContainer: { title: "Internal Space D" },
    ...
    expect(out).toContain("INTD,space,Internal Space D");
